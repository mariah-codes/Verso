...
import { BookActionMenu } from "@/components/book/BookActionMenu"
...
export default function SearchPage() {
  ...
  function handleSuccess(book: BookSearchResult, status: BookStatus) {
    ...
    <>
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <main className="flex-1 px-4 py-5">
          ...
          {showPrompt && (
            <div className="flex flex-col items-center justify-center pt-20 gap-3 text-center">
              ...
              <p className="text-sm text-foreground/50 max-w-xs leading-relaxed">
                Search Open Library&apos;s catalogue of millions of books and
                add them to your shelf.
              </p>
            </div>
          )}
          ...
          {/* Loading skeletons — 3-column grid matching results layout */}
          {showSkeletons && (
      ...
      {/* ── Bottom sheet — rendered outside the scroll container ─────────── */}
      {userId && (
        <BookActionMenu
          book={selectedBook}
          userId={userId}
